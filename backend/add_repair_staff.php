              			...
              			<div class="row">
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        ...
                                        <select name="u_idcard" id="users2" class="form-control" required="">
                                        	<option value="">เลือกผู้แจ้งซ่อม</option>
                                        	<?php
                                            	$sql = "SELECT * FROM tb_user ORDER BY u_idcard ASC";
												$query = mysqli_query($conn, $sql);
												while($row = mysqli_fetch_array($query)) {
											?>
                                        	<option value="<?php echo $row['u_idcard'];?>"><?php echo $row['u_prefix'];?><?php echo $row['u_fname'];?> <?php echo $row['u_lname'];?></option>
                                            <?php } ?>
                                        </select>
                                      </div>
                                    </div>
